<?php
	...
	IF(!isset($_SESSION['user_id'])): header("location: ../myaccount/login"); ENDIF;
//	(WM())? header ('location: dashboard') : header ('location: ../myaccount/login');
                ...
                <div class="col-md-4 col-md-offset-4">
                    <div class="login-panel panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title">Administration - <strong>Authentication</strong></h3>

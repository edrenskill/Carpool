...
$personal_info = mysqli_fetch_assoc(mysqli_query($link, "SELECT userlevel, account_status, username, email, fname, mname, lname, suffix, gender, dob, marital, occupation, religion, zip_code, address, country, region, province, city, barangay, tel, mobile, fax, regdate, user_ID, TIN, sss, photo FROM " . DB_PREFIX . "users WHERE user_ID = '" . $member_ID . "'"));
        ...
        <div id="wrapper">
                ...
                <div class="container-fluid">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            ...
                            <div class="container" id="genpro" style="display:block;margin: 0 0 0 132px;">
								<div style="margin:0 auto; padding:10px 40px 0px 40px" id="avatar">
							   <?php if(!isset($_SESSION['memberID'])){ ?>
									<span class="image avatar"><img src="images/avatar1.jpg" height="30%" alt="" /></span>
									<h1 id="logo">Guest</h1>

								<?php }else{ $myname = mysqli_fetch_array(mysqli_query($link, "SELECT fname, lname, photo FROM ".DB_PREFIX."users WHERE user_ID = '{$member_ID}'")); ?>
									<span class="image avatar">
										<?php IF($myname['photo'] == ""){ $avatar = "images/avatar2.jpg"; }ELSE{ $avatar = "../myaccount/members/".$_SESSION['memberID']."/".$myname['photo']; } ?>
										<img src="<?= $avatar; ?>" style="height: 100px; position: absolute; margin: 0 0 0 -161px;" alt="" />
									</span>
								<?php }?>
								</div>
								<div style="clear:both"></div>
							  ...
							  <div style="clear:both"></div>
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="form-group">
													<label  class="radio-inline">
														<input type="radio" name="civil" class="civil" id="civil" value="1"<?php
														IF (isset($field_civil) && $field_civil == '1'): echo 'checked="checked"';
														ENDIF;
														?> checked />Single<br>
													</label>
													<label  class="radio-inline">
														<input type="radio" name="civil" class="civil" id="civil" value="2"<?php
														IF (isset($field_civil) && $field_civil == '2'): echo 'checked="checked"';
														ENDIF;
														?>/>Married<br>
													</label>
													<label  class="radio-inline">
														<input type="radio" name="civil" class="civil" id="civil" value="3"<?php
														IF (isset($field_civil) && $field_civil == '3'): echo 'checked="checked"';
														ENDIF;
														?>/>Widow<br>
													</label>
													<label  class="radio-inline">
														<input type="radio" name="civil" class="civil" id="civil" value="4"<?php
														IF (isset($field_civil) && $field_civil == '4'): echo 'checked="checked"';
														ENDIF;
														?>/>Seperated<br>
													</label>
													<label  class="radio-inline">
														<input type="radio" name="civil" class="civil" id="civil" value="5"<?php
								...
								<div style="clear:both"></div>
                                <div class="12u(xsmall)" style="color:#0000FF;" id="sss-displaymess">
                                    <span class="sssmessage" id="sssmessage"></span>
                                </div>
					...
					<div style="clear:both"></div>
                            ...
                            <!-- contact person-->													
                           <a href="javascript: null(void)" onclick='$("#caddprolink1").hide();$("#caddprolink2").show("slow");$("#caddpro").show("slow");$("#genprolink1").show("slow");$("#genprolink2").hide();$("#genpro").hide();$("#conprolink1").show("slow");$("#conprolink2").hide();$("#conpro").hide();$("#bankprolink1").show("slow");$("#bankprolink2").hide();$("#bankpro").hide();$("#credentialsprolink1").show("slow");$("#credentialsprolink2").hide();$("#credentials").hide();'><div class="12u(xsmall)" id="caddprolink1" style="border-top:solid 1px #20b990; border-bottom:solid 1px #20b990; padding-left: 10px">▼   Contact Person in Case of  Emergency <?= ($contact_person_info['contact_person'] == "")? "<span style='color:#ff0000;'>--- Please Enter Conatct Person Details ---</span>" : ""; ?></div></a>                      						   
						   <a href="javascript: null(void)" onclick='$("#caddprolink1").show("slow");$("#caddprolink2").hide();$("#caddpro").hide();'><div class="12u(xsmall)" id="caddprolink2" style="display:none; border-top:solid 1px #20b990; border-bottom:solid 1px #20b990; padding-left: 10px">▲   Contact Person in Case of  Emergency</div></a>
                            ...
                            <div class="container" id="caddpro" style='display:<?= ($contact_person_info['contact_person'] == "")? "block;" : "none;"; ?>'>
            ...
            <script language="javascript" type="text/javascript">
				$(document).ready(function() {
					...
					$("#civilsubmit").click(function() {
						var civil = document.ElementById['civil'].elements['civil'];
						// VALIDATE
						len=civil.length-1;
						chkvaluem='';
						for(i=0; i<=len; i++){ if(civil[i].checked)chkvaluem=civil[i].value; }
							if(chkvaluem==''){ 
								$("#warning").show("slow");
								$("#output").html("Civil Status must be selected."); 
								return false; 
							}
							else{
								var civil = $("#civil").val();

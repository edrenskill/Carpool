<?php
	...
	mysqli_query($link, "UPDATE ".DB_PREFIX."reporting SET report_status=1 WHERE report_ID='{$reportID}' AND report_status!=2 AND reply!=1");
	...
	$all_message = mysqli_query($link, "SELECT user_ID, subject, report_ID, reason, date_time, report_status, reply FROM ".DB_PREFIX."reporting WHERE report_ID='{$reportID}' ORDER BY ID ASC");
?>
			...
			<div id="page-wrapper">
				<div class="row">
                    <div class="col-lg-10">
						...
						<span class="pull-right"><a href="notifications"><i class="fa  fa-inbox"></i>Inbox</a></span></h4>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <!-- /.row -->
                    ...
                    <div class="col-lg-10">
						<div class="panel-body">
							<ul class="chat">
								...
								?>
									<?=$headpos;?>
										<a href="gen_id_bridge?memberID=<?=$userID;?>"><img src="<?=$avatar;?>" alt="User Avatar" class="img-circle" height="40" width="40"/></a>
									</span>
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h6 class="panel-title">
                                        <form name="change_status" id="change_status"><input name="orID" id="orID" type="hidden" value="<?=$reportID;?>"/><span id="current_status" name="current_status"><?=$status;?></span><span class="pull-right"><a data-toggle="collapse" data-parent="#ReplyPanel" href="#collapseReplypanel"><i class="fa fa-mail-reply"></i> Reply</a> | <button type="submit" class="btn btn-link"><i class="fa fa-check" ></i> Mark as Resolved</button></span></form>
                                    </h6>
                                </div>
			...
			$(document).ready(function() {
				...
				$('#submit_reply').submit(function (e) {
					...
					if(report_content == ''){
						...
						$.post('trigger/replytoconcenrreport', { 'rID': rID, 'avatar':avatar, 'reportcontent':report_content, 'replyreport': 1}, function(data) {
				...
				$('#change_status').submit(function (e) {
					...
					$.post('trigger/replytoconcenrreport', { 'rID': orID, 'changestat': 1}, function(data) {

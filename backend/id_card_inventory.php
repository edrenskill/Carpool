        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    <div class="row">
						<!-- /.panel-heading -->
						<div class="panel panel-default" style="margin: 57px 0 0 0;">
										...
										<div class="panel-body">
											<div class="dataTable_wrapper">
												<table class="table table-striped table-bordered table-hover" id="dataTables-payout">
													...
													?>
														<tr class="gradeA">
															<td><a href="gen_id_bridge?terminal=<?= $selectedID; ?>" data-toggle="tooltip" title="Edit Terminal Details"><?= strtoupper($terminal_name); ?></a></td>

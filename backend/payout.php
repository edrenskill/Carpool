<?php 
	...
	ELSEIF(isset($_SESSION['fromcardsaleaccount'])):
		unset($_SESSION['fromcardsaleaccount']);	
	ENDIF;
														...
														<tbody>
																...
																<?php
																	...
																	WHILE($drivers = mysqli_fetch_array($records)){
																		...
																		$driver = mysqli_fetch_array(mysqli_query($link, "SELECT fname, mname, lname, suffix, user_ID FROM ".DB_PREFIX."users WHERE user_ID='{$user_ID}'"));

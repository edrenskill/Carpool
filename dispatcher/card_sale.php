												...
												<div class="tab-content">
													<div class="tab-pane fade  active in" id="tab-remit">
														<div class="dataTable_wrapper">
															<form name="remit" id="remit" method="post" action="trigger/update_card_remit">
																<table class="table table-striped table-bordered table-hover" id="dataTables-cards">
																	...
																	<tbody>
																			...
																			<?php
																				$records = mysqli_query($link, "SELECT COUNT(A.ID) AS qty, GROUP_CONCAT(A.card_number SEPARATOR ', ') AS c_number, B.date_sale, SUM(B.amount) AS total_amount FROM ".DB_PREFIX."idcards A, ".DB_PREFIX."card_sale B WHERE A.disposed=1 AND A.terminal_ID='{$terminal_ID}' AND B.card_number=A.card_number AND B.remitted='0' {$dateset} GROUP BY B.date_sale");
																					...
																					<tr class="gradeA">
																						...
																						<td>
																							<div class="form-group input-group">
																								...
																								<input type="hidden" class="form-control" name="ID[]" id="ID[]" value="<?= $C_no; ?>" style="width:90px">
																								<input type="text" class="form-control" name="Rcode[]" id="Rcode[]" value="" style="width:150px">
																								<input type="file" class="form-control" name="depslip[]" id="depslip[]" style="width:250px">

											...
											<div class="dataTable_wrapper">
												<table class="table table-striped table-bordered table-hover" id="dataTables-payout">
													...
													<?php
														...
														$query_cards = mysqli_query($link, "SELECT card_number, status FROM ".DB_PREFIX."idcards WHERE terminal_ID='{$terminal_ID}'");
														...
														<tr class="gradeA">
															...
															<td><span style="float:left;color:#0000FF;"></span><?= ($status = 0)? "Available" : "Sold"; ?></td>
															<td><span style="float:left;color:#0000FF;"></span></td>
														</tr>
													<?php } ?>
													</tbody>
												</table>											

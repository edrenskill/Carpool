...
if (session_id() == '') { page_protect(); } // START SESSIONS
	...
	$personal_info = mysqli_fetch_assoc(mysqli_query($link, "SELECT userlevel, username, email, fname, mname, lname, suffix, gender, dob, marital, occupation, religion, zip_code, address, country, region, province, city, barangay, tel, mobile, fax, regdate, user_ID, TIN, photo FROM " . DB_PREFIX . "users WHERE user_ID = '" . $member_ID . "'"));
		...
		<script language="javascript" type="text/javascript">
			$(document).ready(function() {
				...
				$(".country").change(function() {
					...
					$.ajax({
						type: "POST",
						url: "../profile/includes/location/region.php",
						data: dataString,
						cache: false,
				...
				$(".region").change(function() {
					...
					$.ajax({
						type: "POST",
						url: "../profile/includes/location/province.php",
						data: dataString,
						cache: false,
						success: function(html) {
							$(".province").html(html);
				...
				$(".province").change(function() {
					...
					$.ajax({
						type: "POST",
						url: "../profile/includes/location/city.php",
						data: dataString,
						cache: false,
						success: function(html) {
							$(".city").html(html);
				...
				$(".city").change(function() {
					...
					$.ajax({
						type: "POST",
						url: "../profile/includes/location/barangay.php",
						data: dataString,
						cache: false,
						success: function(html) {
							$(".barangay").html(html);
				...
				$(".ccountry").change(function() {
					...
					$.ajax({
						type: "POST",
						url: "../profile/includes/location/cregion.php",
						data: dataString,
						cache: false,
						success: function(html) {
							$(".cregion").html(html);
				...
				$(".cregion").change(function() {
					...
					$.ajax({
						type: "POST",
						url: "../profile/includes/location/cprovince.php",
						data: dataString,
						cache: false,
						success: function(html) {
							$(".cprovince").html(html);
				...
				$(".cprovince").change(function() {
					...
					$.ajax({
						type: "POST",
						url: "../profile/includes/location/ccity.php",
						data: dataString,
						cache: false,
						success: function(html) {
							$(".ccity").html(html);
				...
				$(".ccity").change(function() {
					...
					$.ajax({
						type: "POST",
						url: "../profile/includes/location/cbarangay.php",
						data: dataString,
						cache: false,
						success: function(html) {
							$(".cbarangay").html(html);

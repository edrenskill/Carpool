	...
	ELSE:	
		...
		IF($account_exist): 
			...
			// Check wallet balance
				...
				$transaction_sql_insert = "INSERT into `".DB_PREFIX."terminaltrans` (`ref_no`,`trans_date`,`trans_time`,`transaction_code`,`user_ID`,`debit`,`terminal_ID`)
				VALUES ('$gen_transcode','$date','$time','$dtcode','$mID','$load_amount','$terminal_ID')";

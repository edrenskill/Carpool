...
define ("DB_USER", "carpoolphil_carpoolphil"); 	// DATABASE USER
define ("DB_PASS","ReallyImpo5i3le"); 	// DATABASE PASSWORD
define ("DB_NAME","carpoolphil_edit");	// DATABASE NAME
...
if(!function_exists("create_square_image")){
	function create_square_image($original_file, $destination_file=NULL, $square_size = 96){
		...
		if($new_height>$new_width){
			...
			$half_difference =  round($difference/2);
			imagecopyresampled($square_image, $smaller_image, 0, 0, 0, 0, $square_size, $square_size+$difference, $new_width, $new_height);
		}
		if($new_height == $new_width){
...
////////////////////////////// MESSEGING TIME LAPSE////////////////////////////////
	...
	IF($symbol == ""): $symbol = $currency['ISO_4217_code']; ENDIF;
